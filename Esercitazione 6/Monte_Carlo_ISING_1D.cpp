...
//initial configuration
  if (restart == 0) {
      ...
      cout << "Read configuration form config.final" << endl;
...
{
  int o;
  double p, energy_old, energy_new, sm, A, r;
...
void Averages(int iblk) //Print results for current block
{
   ...
   const int wd=12;
    ...
    if (restart == 1) {         //Abilito scrittura su file solo dopo la fase di equilibrazione
        if (metro == 1) {
            if (temp == 0) {
                Ene.open("output_metro.ene.0", ios::app);
                Heat.open("output_metro.heat.0", ios::app);
                Mag.open("output_metro.mag.0", ios::app);
                Chi.open("output_metro.chi.0", ios::app);
                ...
                Ene.open("output_metro.ene.h", ios::app);
                Heat.open("output_metro.heat.h", ios::app);
                Mag.open("output_metro.mag.h", ios::app);
                Chi.open("output_metro.chi.h", ios::app);
                Ene << setw(wd) << iblk << setw(wd) << temp << setw(wd) << stima_u << setw(wd) << glob_av[iu] / (double)iblk << setw(wd) << err_u << endl;
                Heat << setw(wd) << iblk << setw(wd) << temp << setw(wd) << stima_c << setw(wd) << glob_av[ic] / (double)iblk << setw(wd) << err_c << endl;
                Mag << setw(wd) << iblk << setw(wd) << temp << setw(wd) << stima_m << setw(wd) << glob_av[im] / (double)iblk << setw(wd) << err_m << endl;
                Chi << setw(wd) << iblk << setw(wd) << temp << setw(wd) << stima_x << setw(wd) << glob_av[ix] / (double)iblk << setw(wd) << err_x << endl;
            ...
            if (temp == 0) {
                Ene.open("output_gibbs.ene.0", ios::app);
                Heat.open("output_gibbs.heat.0", ios::app);
                Mag.open("output_gibbs.mag.0", ios::app);
                Chi.open("output_gibbs.chi.0", ios::app);
                Ene << setw(wd) << iblk << setw(wd) << temp << setw(wd) << stima_u << setw(wd) << glob_av[iu] / (double)iblk << setw(wd) << err_u << endl;
                Heat << setw(wd) << iblk << setw(wd) << temp << setw(wd) << stima_c << setw(wd) << glob_av[ic] / (double)iblk << setw(wd) << err_c << endl;
                Mag << setw(wd) << iblk << setw(wd) << temp << setw(wd) << stima_m << setw(wd) << glob_av[im] / (double)iblk << setw(wd) << err_m << endl;
                Chi << setw(wd) << iblk << setw(wd) << temp << setw(wd) << stima_x << setw(wd) << glob_av[ix] / (double)iblk << setw(wd) << err_x << endl;
                ...
                Ene.open("output_gibbs.ene.h", ios::app);
                Heat.open("output_gibbs.heat.h", ios::app);
                Mag.open("output_gibbs.mag.h", ios::app);
                Chi.open("output_gibbs.chi.h", ios::app);
                Ene << setw(wd) << iblk << setw(wd) << temp << setw(wd) << stima_u << setw(wd) << glob_av[iu] / (double)iblk << setw(wd) << err_u << endl;
                Heat << setw(wd) << iblk << setw(wd) << temp << setw(wd) << stima_c << setw(wd) << glob_av[ic] / (double)iblk << setw(wd) << err_c << endl;
                Mag << setw(wd) << iblk << setw(wd) << temp << setw(wd) << stima_m << setw(wd) << glob_av[im] / (double)iblk << setw(wd) << err_m << endl;
                Chi << setw(wd) << iblk << setw(wd) << temp << setw(wd) << stima_x << setw(wd) << glob_av[ix] / (double)iblk << setw(wd) << err_x << endl;
